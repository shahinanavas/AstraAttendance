        ...
        <div class="d-flex justify-content-end">
            <a href="{{ url('/taskadd') }}" class="btn btn-primary me-3">
                <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-person-plus" viewBox="0 0 16 16">
                    ...
                    <path fill-rule="evenodd" d="M13.5 5a.5.5 0 0 1 .5.5V7h1.5a.5.5 0 0 1 0 1H14v1.5a.5.5 0 0 1-1 0v-1.5H11a.5.5 0 0 1 0-1h1v-1H13a.5.5 0 0 1-.5-.5zM1 13.5A1.5.5 0 0 0 2.5 15h11a1.5.5 0 0 0 1.5-1.5v-6a.5.5 0 0 0-1 0v6a.5.5 0 0 1-.5.5H2.5a.5.5 0 0 1-.5-.5v-11a.5.5 0 0 1 .5-.5H9a.5.5 0 0 0 0-1H2.5A1.5.5 0 0 0 1 2.5z"/>
                </svg> ADD
            </a>
        </div>
    </div>
            ...
            <table class="table table-bordered">
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td>
                            @php
                                $assignedToNames = explode(',', $task->assigned_to_name);
                            @endphp
                            @foreach($assignedToNames as $assign)
                                {{ $assign }}
                                @if (!$loop->last)
                                    <br>
                                @endif
